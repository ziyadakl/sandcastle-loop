...
!`if [ -f /tmp/ralph-e2e-it{{ITERATION}}.log ]; then cat /tmp/ralph-e2e-it{{ITERATION}}.log; else echo "(no /tmp/ralph-e2e-it{{ITERATION}}.log present — implementer did not run agent-browser)"; fi`
